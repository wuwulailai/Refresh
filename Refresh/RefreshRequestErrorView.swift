...
public class RefreshRequestErrorView: UIView {

    public var refreshRequestErrorViewBlock: RefreshRefreshingBlock?
    ...
    public lazy var tipImageView: UIImageView = {
        ...
        let image = UIImage.init(named: "RefreshTableView.bundle/refreshtableview_requesterror", in: Bundle.init(for: RefreshNoNetworkView.self), compatibleWith: nil)
