...
public class RefreshNoNetworkView: UIView {

    public var refreshNoNetworkViewBlock: RefreshRefreshingBlock?
    ...
    public lazy var tipImageView: UIImageView = {
        ...
        let image = UIImage.init(named: "RefreshTableView.bundle/refreshtableview_nonetwork.png", in: Bundle.init(for: RefreshNoNetworkView.self), compatibleWith: nil)
