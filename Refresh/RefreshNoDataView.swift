...
public class RefreshNoDataView: UIView {
    ...
    public lazy var tipImageView: UIImageView = {
        ...
        let image = UIImage.init(named: "RefreshTableView.bundle/refreshtableview_defaultnodata", in: Bundle.init(for: RefreshNoDataView.self), compatibleWith: nil)
